# @collabsoft-net/caching

Collection of classes to implement caching for Firebase Cloud Functions.
...
```
npm install @collabsoft-net/caching
```
...
```
yarn add @collabsoft-net/caching
```
