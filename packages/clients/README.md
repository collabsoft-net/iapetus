...
Rest clients to be used in Server, Cloud functions and client-side (with support for AP.request and Atlassian REST API, incl. impersonation)
...
```
npm install @collabsoft-net/clients
```
