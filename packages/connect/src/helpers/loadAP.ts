...
export const loadAP = async <T extends AP.JiraInstance|AP.ConfluenceInstance|AP.BambooInstance|AP.BitbucketInstance>(options: {
  ...
  try {
    const AP = await (windowWithAP.AP
      ? new Promise<AP.JiraInstance|AP.ConfluenceInstance|AP.BambooInstance|AP.BitbucketInstance>(resolve => resolve(windowWithAP.AP))
      : new Promise<AP.JiraInstance|AP.ConfluenceInstance|AP.BambooInstance|AP.BitbucketInstance>((resolve, reject) => {
