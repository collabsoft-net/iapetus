...
export abstract class AbstractRestClientService {
  ...
  async get<T extends DTO|EntityDTO<Entity>>(type: Type<T>, id: string, params: Record<string, string|number|boolean|undefined> = {}): Promise<T|null> {
  ...
  async findOne<T extends DTO|EntityDTO<Entity>>(type: Type<T>, params: Record<string, string|number|boolean|undefined> = {}): Promise<T|null> {
  ...
  async findAll<T extends DTO|EntityDTO<Entity>>(type: Type<T>, params: Record<string, string|number|boolean|undefined> = {}): Promise<Paginated<T>> {
  ...
  async createOrUpdate<T extends DTO|EntityDTO<Entity>>(type: Type<T>, item: T, params: Record<string, string|number|boolean|undefined> = {}): Promise<T> {
    if (item.id === '-1') {
      delete item.id;
    }
  ...
  async remove<T extends DTO|EntityDTO<Entity>>(item: T, params: Record<string, string|number|boolean|undefined> = {}): Promise<void> {
  ...
  protected getEndpointFor<T extends DTO|EntityDTO<Entity>>(endpoint: RestClientEndpoints|string, type: Type<T>|T): string;
  protected getEndpointFor<T extends DTO|EntityDTO<Entity>>(endpoint: RestClientEndpoints|string, type: Type<T>|T, pathParams: Record<string, string|undefined>): string;
  protected getEndpointFor<T extends DTO|EntityDTO<Entity>>(endpoint: RestClientEndpoints|string, typeOrpathParams?: Type<T>|T|Record<string, string|undefined>, pathParams?: Record<string, string|undefined>): string {
