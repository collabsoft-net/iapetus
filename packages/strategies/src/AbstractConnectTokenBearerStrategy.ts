...
@injectable()
export abstract class AbstractAtlassianTokenBearerStrategy<T extends ACInstance, X extends ACInstanceDTO, Y extends ConnectSession> extends AbstractBearerStrategy<Y> {
