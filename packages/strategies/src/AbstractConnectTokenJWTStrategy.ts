...
@injectable()
export abstract class AbstractAtlassianTokenJWTStrategy<T extends ACInstance, X extends ACInstanceDTO, Y extends ConnectSession> extends AbstractJWTStrategy<Atlassian.JWT, Y> {
