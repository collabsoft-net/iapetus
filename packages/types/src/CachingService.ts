...
export interface CachingService {
  ...
  get<T>(key: string, loader: () => Promise<T | null>, expiresInSeconds?: number): Promise<T | null>;
  get<T>(key: string, loader: () => Promise<T | null>, expiresInSeconds?: number, forceRefresh?: boolean): Promise<T | null>;
